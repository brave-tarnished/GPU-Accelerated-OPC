...
PolygonData processAndFragment(const PolygonData& input, float edgeStepSize, float cornerStepSize, 
    ...
    for (int polySize : input.polygonSizes) {
        ...
        output.polygonSizes.push_back(fragmentedPoints.size());
        output.points.insert(output.points.end(), fragmentedPoints.begin(), fragmentedPoints.end());
...
int main() {
    try {
        ...
        PolygonData output = processAndFragment(input, edgeStepSize, cornerStepSize, 
